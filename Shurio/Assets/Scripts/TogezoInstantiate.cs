...
public class TogezoInstantiate : MonoBehaviour
{
    ...
    void Update()
    {
		if (sleep <= time) {
			...
			GameObject togezos = GameObject.Instantiate(togezo,posi, Quaternion.identity);
			//togezos.GetComponent<AudioSource>().Play();
		}
